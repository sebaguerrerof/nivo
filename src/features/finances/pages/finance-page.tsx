      ...
      <IonContent fullscreen>
        <main className="min-h-full px-5 pb-28 pt-7 sm:px-8 lg:px-12 lg:pb-10 lg:pt-10">
          <div className="mx-auto max-w-6xl">
            ...
            {overview.isError || transactions.isError || categories.isError ? <Alert variant="error">No pudimos cargar tus finanzas. Actualiza la página e inténtalo nuevamente.</Alert> : null}
